...
class SERDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Extract features
        features = self.feature_extractor.extract_from_waveform(waveform, self.sample_rate)
...
def main():
    ...
    parser.add_argument('--data_dir', type=str, default='data/ser',
    ...
    parser.add_argument('--weight_decay', type=float, default=1e-5,
                        help='Weight decay')
    parser.add_argument('--checkpoint_dir', type=str, default='checkpoints/ser',
                        help='Directory to save checkpoints')
    parser.add_argument('--log_dir', type=str, default='logs/ser',
