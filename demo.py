...
class HumanVoiceAI:
    ...
    def __init__(self, device=DEVICE):
        ...
        self.feature_extractor = FeatureExtractor(sample_rate=SAMPLE_RATE).to(
            self.device
        )
    ...
    def detect_emotion(self, audio_path):
        ...
        # Detect emotion
        emotion_idx, emotion_probs = self.ser_model.predict_emotion(
        ...
        print(
            f"Detected emotion: {emotion_label} (Confidence: {emotion_probs[0][emotion_idx[0]]*100:.2f}%)"
        )
    ...
    def text_to_speech(self, text, emotion_idx=None, save_path=None):
        ...
        if save_path:
            ...
            torchaudio.save(
                save_path, torch.FloatTensor(audio).unsqueeze(0), SAMPLE_RATE
            )
...
def main():
    ...
    parser.add_argument(
        "--text",
        type=str,
        default="Hello, this is a test of the Human Voice AI system.",
    ...
    parser.add_argument(
        "--output",
        type=str,
        default="output/generated_speech.wav",
